...
public class NewsetAdapter extends RecyclerView.Adapter<NewsetAdapter.BeautyViewHolder> {
    /**
     * 上下文
     */
    ...
    public NewsetAdapter(List<FruitImageText> data, BookmallSchoolgirlFragment context) {
        this.data = data;
    ...
    public BeautyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //加载item 布局文件
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.schoolgirl_newset_item, parent
                , false);
    ...
    static class BeautyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BeautyViewHolder(View itemView) {
            super(itemView);
            beautyImage = itemView.findViewById(R.id.newset_item_img);
            nameCentent = itemView.findViewById(R.id.newset_item_txt);
        }
    }
