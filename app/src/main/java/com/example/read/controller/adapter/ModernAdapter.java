...
public class ModernAdapter extends RecyclerView.Adapter<ModernAdapter.BeautyViewHolder> {
    /**
     * 上下文
     */
    ...
    public ModernAdapter(List<FruitImageText> data, BookmallSchoolgirlFragment context) {
        this.data = data;
    ...
    public BeautyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //加载item 布局文件
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.schoolgirl_modern_item, parent
                , false);
    ...
    static class BeautyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BeautyViewHolder(View itemView) {
            super(itemView);
            beautyImage = itemView.findViewById(R.id.modern_item_img);
            nameCentent = itemView.findViewById(R.id.modern_item_txt);
        }
    }
