...
public class BoutiqueAdapter extends RecyclerView.Adapter<BoutiqueAdapter.BeautyViewHolder> {
    /**
     * 上下文
     */
    ...
    public BoutiqueAdapter(List<FruitImageText> data, BookmallSchoolgirlFragment context) {
        this.data = data;
    ...
    public BeautyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //加载item 布局文件
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.schoolgirl_boutique_item, parent
                , false);
    ...
    static class BeautyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BeautyViewHolder(View itemView) {
            super(itemView);
            beautyImage = itemView.findViewById(R.id.boutique_item_img);
            nameCentent = itemView.findViewById(R.id.boutique_item_txt);
        }
    }
