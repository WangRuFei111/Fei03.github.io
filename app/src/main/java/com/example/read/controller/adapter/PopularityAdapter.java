...
public class PopularityAdapter extends RecyclerView.Adapter<PopularityAdapter.BeautyViewHolder> {
    /**
     * 上下文
     */
    ...
    public PopularityAdapter(List<FruitImageText> data, BookmallChoicenessFragmgnt context) {
        this.data = data;
    ...
    public BeautyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //加载item 布局文件
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.choiceness_popularity_item, parent
                , false);
    ...
    static class BeautyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BeautyViewHolder(View itemView) {
            super(itemView);
            beautyImage = itemView.findViewById(R.id.popularity_item_img);
            nameCentent = itemView.findViewById(R.id.popularity_item_txt);
        }
    }
