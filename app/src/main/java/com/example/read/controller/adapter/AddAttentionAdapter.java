...
public class AddAttentionAdapter extends RecyclerView.Adapter<AddAttentionAdapter.BeautyViewHolder> {
    /**
     * 上下文
     */
    private AddAttentionActivity mContext;
    /**
     * 数据集合
     */
        private List<FruitImageTextTow> data;

    public AddAttentionAdapter(List<FruitImageTextTow> data, AddAttentionActivity context) {
        this.data = data;
